...
const jo = (e) => new Jr(typeof e == "string" ? e : e + "", void 0, fr), S = (e, ...t) => {
...
const ne = window, Pr = ne.trustedTypes, Ho = Pr ? Pr.emptyScript : "", Ir = ne.reactiveElementPolyfillSupport, ke = { toAttribute(e, t) {
  ...
  return r;
} }, Xr = (e, t) => t !== e && (t == t || e == e), Ce = { attribute: !0, type: String, converter: ke, reflect: !1, hasChanged: Xr }, He = "finalized";
let wt = class extends HTMLElement {
  ...
  requestUpdate(t, r, n) {
    let o = !0;
    t !== void 0 && (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || Xr)(this[t], r) ? (this._$AL.has(t) || this._$AL.set(t, r), n.reflect === !0 && this._$El !== t && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t, n))) : o = !1), !this.isUpdatePending && o && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
 ...
 */
var Ee;
const ie = window, $t = ie.trustedTypes, Tr = $t ? $t.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ze = "$lit$", J = `lit$${(Math.random() + "").slice(9)}$`, to = "?" + J, zo = `<${to}>`, ut = document, Wt = () => ut.createComment(""), Ut = (e) => e === null || typeof e != "object" && typeof e != "function", eo = Array.isArray, Fo = (e) => eo(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ae = `[ 	
\f\r]`, Dt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Mr = /-->/g, Sr = />/g, at = RegExp(`>|${Ae}(?:([^\\s"'>=/]+)(${Ae}*=${Ae}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Rr = /'/g, Dr = /"/g, ro = /^(?:script|style|textarea|title)$/i, oo = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), m = oo(1), N = oo(2), mt = Symbol.for("lit-noChange"), B = Symbol.for("lit-nothing"), Nr = /* @__PURE__ */ new WeakMap(), ct = ut.createTreeWalker(ut, 129, null, !1);
function no(e, t) {
...
const Vo = (e, t) => {
  ...
  for (let l = 0; l < r; l++) {
    ...
    for (; h < a.length && (s.lastIndex = h, d = s.exec(a), d !== null); )
      h = s.lastIndex, s === Dt ? d[1] === "!--" ? s = Mr : d[1] !== void 0 ? s = Sr : d[2] !== void 0 ? (ro.test(d[2]) && (o = RegExp("</" + d[2], "g")), s = at) : d[3] !== void 0 && (s = at) : s === at ? d[0] === ">" ? (s = o ?? Dt, b = -1) : d[1] === void 0 ? b = -2 : (b = s.lastIndex - d[2].length, c = d[1], s = d[3] === void 0 ? at : d[3] === '"' ? Dr : Rr) : s === Dr || s === Rr ? s = at : s === Mr || s === Sr ? s = Dt : (s = at, o = void 0);
    const u = s === at && e[l + 1].startsWith("/>") ? " " : "";
    i += s === Dt ? a + zo : b >= 0 ? (n.push(c), a.slice(0, b) + ze + a.slice(b) + J + u) : a + J + (b === -2 ? (n.push(void 0), l) : u);
  }
  return [no(e, i + (e[r] || "<?>") + (t === 2 ? "</svg>" : "")), n];
};
class jt {
      ...
      if (o.nodeType === 1) {
          ...
          for (const h of o.getAttributeNames())
            if (h.endsWith(ze) || h.startsWith(J)) {
              ...
              if (b.push(h), u !== void 0) {
                const g = o.getAttribute(u.toLowerCase() + ze).split(J), f = /([.?@])?(.*)/.exec(u);
        ...
        if (ro.test(o.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let u = 0; u < h; u++)
              o.append(b[u], Wt()), ct.nextNode(), a.push({ type: 2, index: ++i });
            o.append(b[h], Wt());
          }
        }
...
class qt {
  ...
  g(t) {
    var r;
    const { values: n, _$litType$: o } = t, i = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = jt.createElement(no(o.h, o.h[0]), this.options)), o);
  ...
  T(t) {
    ...
    let n, o = 0;
    for (const i of t)
      o === r.length ? r.push(n = new qt(this.k(Wt()), this.k(Wt()), this, this.options)) : n = r[o], n._$AI(i), o++;
...
class ge {
  ...
  _$AI(t, r = this, n, o) {
    ...
    let s = !1;
    if (i === void 0)
      t = _t(this, t, r, 0), s = !Ut(t) || t !== this._$AH && t !== mt, s && (this._$AH = t);
    else {
      const l = t;
      let a, c;
      for (t = i[0], a = 0; a < i.length - 1; a++)
        c = _t(this, l[n + a], r, a), c === mt && (c = this._$AH[a]), s || (s = !Ut(c) || c !== this._$AH[a]), c === B ? t = B : t !== B && (t += (c ?? "") + i[a + 1]), this._$AH[a] = c;
    }
    s && !o && this.j(t);
  }
  j(t) {
...
const io = (e, t, r) => Math.min(Math.max(r, e), t), H = {
  duration: 0.3,
  delay: 0,
  endDelay: 0,
  repeat: 0,
...
function cn(e, t = an(e.length), r = et) {
  ...
  return o > 0 && ao(t, o), (i) => {
    ...
    for (; s < n - 2 && !(i < t[s + 1]); s++)
      ;
    let l = io(0, 1, pr(t[s], t[s + 1], i));
    return l = ln(r, s)(l), so(e[s], e[s + 1], l);
  };
}
const co = (e) => Array.isArray(e) && se(e[0]), Fe = (e) => typeof e == "object" && !!e.createAnimation, Ct = (e) => typeof e == "function", dn = (e) => typeof e == "string", Lt = {
  ms: (e) => e * 1e3,
  s: (e) => e / 1e3
}, ho = (e, t, r) => (((1 - 3 * r + 3 * t) * e + (3 * r - 6 * t)) * e + 3 * t) * e, hn = 1e-7, un = 12;
function mn(e, t, r, n, o) {
  let i, s, l = 0;
  do
    s = t + (r - t) / 2, i = ho(s, n, o) - e, i > 0 ? r = s : t = s;
...
class uo {
  constructor(t, r = [0, 1], { easing: n, duration: o = H.duration, delay: i = H.delay, endDelay: s = H.endDelay, repeat: l = H.repeat, offset: a, direction: c = "normal" } = {}) {
    if (this.startTime = null, this.rate = 1, this.t = 0, this.cancelTimestamp = null, this.easing = et, this.duration = 0, this.totalDuration = 0, this.repeat = 0, this.playState = "idle", this.finished = new Promise((b, h) => {
      this.resolve = b, this.reject = h;
    }), n = n || H.easing, Fe(n)) {
      const b = n.createAnimation(r);
      n = b.easing, r = b.keyframes || r, o = b.duration || o;
    }
    this.repeat = l, this.easing = bt(n) ? et : Ur(n), this.updateDuration(o);
    const d = cn(r, a, bt(n) ? n.map(Ur) : et);
    this.tick = (b) => {
      var h;
      i = i;
      let u = 0;
      ...
      const g = u / this.duration;
      let f = Math.floor(g), _ = g % 1;
      !_ && g >= 1 && (_ = 1), _ === 1 && f--;
      const p = f % 2;
      (c === "reverse" || c === "alternate" && p || c === "alternate-reverse" && !p) && (_ = 1 - _);
      const y = u >= this.totalDuration ? 1 : Math.min(_, 1), v = d(this.easing(y));
...
const vn = ["", "X", "Y", "Z"], bn = ["translate", "scale", "rotate", "skew"], le = {
  x: "translateX",
  y: "translateY",
  z: "translateZ"
}, jr = {
...
bn.forEach((e) => {
  vn.forEach((t) => {
    ae.push(e + t), kt.set(gr(e + t), yn[e]);
  });
});
const xn = (e, t) => ae.indexOf(e) - ae.indexOf(t), $n = new Set(ae), fo = (e) => $n.has(e), _n = (e, t) => {
  le[t] && (t = le[t]);
  const { transforms: r } = mo(e);
  nn(r, t), e.style.transform = Cn(r);
}, Cn = (e) => e.sort(xn).reduce(En, "").trim(), En = (e, t) => `${e} ${t}(var(${gr(t)}))`, Ze = (e) => e.startsWith("--"), kr = /* @__PURE__ */ new Set();
function An(e) {
  if (!kr.has(e)) {
    kr.add(e);
    try {
...
const Me = (e, t) => document.createElement("div").animate(e, t), Hr = {
...
for (const e in Hr)
  vt[e] = () => (Se[e] === void 0 && (Se[e] = Hr[e]()), Se[e]);
const On = 0.015, Pn = (e, t) => {
  let r = "";
  const n = Math.round(t / On);
  for (let o = 0; o < n; o++)
    r += e(pr(0, n - 1, o)) + ", ";
  return r.substring(0, r.length - 2);
}, zr = (e, t) => Ct(e) ? vt.linearEasing() ? `linear(${Pn(e, t)})` : H.easing : co(e) ? In(e) : e, In = ([e, t, r, n]) => `cubic-bezier(${e}, ${t}, ${r}, ${n})`;
function Tn(e, t) {
...
function qe(e) {
  return le[e] && (e = le[e]), fo(e) ? gr(e) : e;
}
const Xt = {
  get: (e, t) => {
    t = qe(t);
...
function Dn(e, t, r, n = {}, o) {
  ...
  let l, { duration: a = H.duration, delay: c = H.delay, endDelay: d = H.endDelay, repeat: b = H.repeat, easing: h = H.easing, persist: u = !1, direction: g, offset: f, allowWebkitAcceleration: _ = !1 } = n;
  const p = mo(e), y = fo(t);
  let v = vt.waapi();
  y && _n(e, t);
  const w = qe(t), P = wn(p.values, w), I = kt.get(w);
  return po(P.animation, !(Fe(h) && P.generator) && n.record !== !1), () => {
    const D = () => {
      var M, F;
      return (F = (M = Xt.get(e, w)) !== null && M !== void 0 ? M : I == null ? void 0 : I.initialValue) !== null && F !== void 0 ? F : 0;
    };
    let T = Tn(Mn(r), D);
    const z = Sn(T, I);
    if (Fe(h)) {
      const M = h.createAnimation(T, t !== "opacity", D, w, P);
      h = M.easing, T = M.keyframes || T, a = M.duration || a;
    }
    if (Ze(w) && (vt.cssRegisterProperty() ? An(w) : v = !1), y && !vt.linearEasing() && (Ct(h) || bt(h) && h.some(Ct)) && (v = !1), v) {
      I && (T = T.map((V) => se(V) ? I.toDefaultUnit(V) : V)), T.length === 1 && (!vt.partialKeyframes() || s) && T.unshift(D());
      const M = {
        delay: Lt.ms(c),
        duration: Lt.ms(a),
        endDelay: Lt.ms(d),
        easing: bt(h) ? void 0 : zr(h, a),
        direction: g,
        iterations: b + 1,
        fill: "both"
      };
      l = e.animate({
        [w]: T,
        offset: f,
        easing: bt(h) ? h.map((V) => zr(V, a)) : void 0
      }, M), l.finished || (l.finished = new Promise((V, Z) => {
        l.onfinish = V, l.oncancel = Z;
      }));
      const F = T[T.length - 1];
      l.finished.then(() => {
        u || (Xt.set(e, w, F), l.cancel());
      }).catch(lo), _ || (l.playbackRate = 1.000001);
    } else if (o && y)
      T = T.map((M) => typeof M == "string" ? parseFloat(M) : M), T.length === 1 && T.unshift(parseFloat(D())), l = new o((M) => {
        Xt.set(e, w, z ? z(M) : M);
      ...
      Xt.set(e, w, I && se(M) ? I.toDefaultUnit(M) : M);
    }
    return s && i(e, t, T, {
      duration: a,
      delay: c,
...
const Bn = (e) => e(), go = (e, t, r = H.duration) => new Proxy({
  animations: e.map(Bn).filter(Boolean),
  duration: r,
  options: t
}, Un), Wn = (e) => e.animations[0], Un = {
  get: (e, t) => {
    const r = Wn(e);
    switch (t) {
      case "duration":
      ...
      case "finished":
        return e.finished || (e.finished = Promise.all(e.animations.map(jn)).catch(lo)), e.finished;
      case "stop":
        return () => {
          e.animations.forEach((n) => po(n));
        };
      case "forEachNative":
        return (n) => {
...
var yo = {};
const Yn = k.getSymbolSize, Fr = 7;
yo.getPositions = function(t) {
  const r = Yn(t);
  return [
    // top-left
    [0, 0],
...
(function(e) {
  ...
  e.isValid = function(o) {
    ...
    for (let b = 0; b < i; b++) {
      ...
      for (let h = 0; h < i; h++) {
        let u = o.get(b, h);
        u === c ? l++ : (l >= 5 && (s += t.N1 + (l - 5)), c = u, l = 1), u = o.get(h, b), u === d ? a++ : (a >= 5 && (s += t.N1 + (a - 5)), d = u, a = 1);
      }
...
vr.prototype.initialize = function(t) {
  this.degree = t, this.genPoly = _o.generateECPolynomial(this.degree);
};
vr.prototype.encode = function(t) {
  ...
  r.set(t);
  const n = _o.mod(r, this.genPoly), o = this.degree - n.length;
  if (o > 0) {
...
Ht = Ht.replace(/u/g, "\\u");
const Jn = "(?:(?![A-Z0-9 $%*+\\-./:]|" + Ht + `)(?:.|[\r
]))+`;
Y.KANJI = new RegExp(Ht, "g");
Y.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
Y.BYTE = new RegExp(Jn, "g");
Y.NUMERIC = new RegExp(Eo, "g");
Y.ALPHANUMERIC = new RegExp(Gn, "g");
const Xn = new RegExp("^" + Ht + "$"), ti = new RegExp("^" + Eo + "$"), ei = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function(e) {
  const t = k, r = ve, n = we, o = st, i = br, s = 7973, l = t.getBCHDigit(s);
  function a(h, u, g) {
    for (let f = 1; f <= 40; f++)
      if (u <= e.getCapacity(f, g, h))
        return f;
  }
  function c(h, u) {
  ...
  function b(h, u) {
    for (let g = 1; g <= 40; g++)
      if (d(h, g) <= e.getCapacity(g, u, o.MIXED))
        return g;
  }
  e.from = function(u, g) {
    return i.isValid(u) ? parseInt(u, 10) : g;
  }, e.getCapacity = function(u, g, f) {
    if (!i.isValid(u))
      throw new Error("Invalid QR Code version");
    typeof f > "u" && (f = o.BYTE);
    const _ = t.getSymbolTotalCodewords(u), p = r.getTotalCodewordsCount(u, g), y = (_ - p) * 8;
    if (f === o.MIXED)
      return y;
    const v = y - c(f, u);
    switch (f) {
  ...
  }, e.getBestVersionForData = function(u, g) {
    let f;
    const _ = n.from(g, n.M);
    if (Array.isArray(u)) {
      if (u.length > 1)
        return b(u, _);
      if (u.length === 0)
...
var Ao = {};
const Ke = k, Oo = 1335, ri = 21522, Vr = Ke.getBCHDigit(Oo);
Ao.getEncodedBits = function(t, r) {
  const n = t.bit << 3 | r;
  let o = n << 10;
  for (; Ke.getBCHDigit(o) - Vr >= 0; )
    o ^= Oo << Ke.getBCHDigit(o) - Vr;
  return (n << 10 | o) ^ ri;
};
var Po = {};
const oi = st;
...
(function(e) {
  var t = {
    single_source_shortest_paths: function(r, n, o) {
      ...
      l.push(n, 0);
      for (var a, c, d, b, h, u, g, f, _; !l.empty(); ) {
        a = l.pop(), c = a.value, b = a.cost, h = r[c] || {};
        for (d in h)
          h.hasOwnProperty(d) && (u = h[d], g = b + u, f = s[d], _ = typeof s[d] > "u", (_ || f > g) && (s[d] = g, l.push(d, g), i[d] = c));
      }
...
var fi = Io.exports;
(function(e) {
  const t = st, r = ni, n = si, o = di, i = mi, s = Y, l = k, a = fi;
  function c(p) {
  ...
  function b(p) {
    const y = d(s.NUMERIC, t.NUMERIC, p), v = d(s.ALPHANUMERIC, t.ALPHANUMERIC, p);
    let w, P;
    return l.isKanjiModeEnabled() ? (w = d(s.BYTE, t.BYTE, p), P = d(s.KANJI, t.KANJI, p)) : (w = d(s.BYTE_KANJI, t.BYTE, p), P = []), y.concat(v, w, P).sort(function(D, T) {
      return D.index - T.index;
    }).map(function(D) {
      return {
        data: D.data,
        mode: D.mode,
  ...
  function f(p, y) {
    ...
    for (let I = 0; I < p.length; I++) {
      ...
      for (let z = 0; z < D.length; z++) {
        const M = D[z], F = "" + I + z;
        T.push(F), v[F] = { node: M, lastCount: 0 }, w[F] = {};
        for (let V = 0; V < P.length; V++) {
          const Z = P[V];
          v[Z] && v[Z].node.mode === M.mode ? (w[Z][F] = h(v[Z].lastCount + M.length, M.mode) - h(v[Z].lastCount, M.mode), v[Z].lastCount += M.length) : (v[Z] && (v[Z].lastCount = M.length), w[Z][F] = h(M.length, M.mode) + 4 + t.getCharCountIndicator(M.mode, y));
        }
      }
      P = T;
    }
  ...
  function _(p, y) {
    let v;
    const w = t.getBestModeForData(p);
    if (v = t.from(y, w), v !== t.BYTE && v.bit < w.bit)
      throw new Error('"' + p + '" cannot be encoded with mode ' + t.toString(v) + `.
 Suggested mode is: ` + t.toString(w));
  ...
  e.fromArray = function(y) {
    return y.reduce(function(v, w) {
      return typeof w == "string" ? v.push(_(w, null)) : w.data && v.push(_(w.data, w.mode)), v;
    }, []);
  }, e.fromString = function(y, v) {
    const w = b(y, l.isKanjiModeEnabled()), P = g(w), I = f(P, v), D = a.find_path(I.map, "start", "end"), T = [];
    for (let z = 1; z < D.length - 1; z++)
      T.push(I.table[D[z]].node);
...
const ye = k, De = we, pi = qn, gi = Kn, wi = bo, vi = yo, Ye = xo, Qe = ve, bi = Qn, de = Co, yi = Ao, xi = st, Ne = Po;
function $i(e, t) {
...
function Oi(e, t, r) {
  ...
  r.forEach(function(a) {
    n.put(a.mode.bit, 4), n.put(a.getLength(), xi.getCharCountIndicator(a.mode, e)), a.write(n);
  });
...
function Pi(e, t, r) {
  const n = ye.getSymbolTotalCodewords(t), o = Qe.getTotalCodewordsCount(t, r), i = n - o, s = Qe.getBlocksCount(t, r), l = n % s, a = s - l, c = Math.floor(n / s), d = Math.floor(i / s), b = d + 1, h = c - d, u = new bi(h);
  let g = 0;
  const f = new Array(s), _ = new Array(s);
  let p = 0;
  const y = new Uint8Array(e.buffer);
  for (let D = 0; D < s; D++) {
    const T = D < a ? d : b;
    f[D] = y.slice(g, g + T), _[D] = u.encode(f[D]), g += T, p = Math.max(p, T);
  }
  const v = new Uint8Array(n);
  let w = 0, P, I;
  for (P = 0; P < p; P++)
    for (I = 0; I < s; I++)
      P < f[I].length && (v[w++] = f[I][P]);
  for (P = 0; P < h; P++)
    for (I = 0; I < s; I++)
      v[w++] = _[I][P];
  return v;
...
`
  ...
  const s = Oi(t, r, o), l = ye.getSymbolSize(t), a = new gi(l);
  return $i(a, t), _i(a), Ci(a, t), Le(a, r, 0), t >= 7 && Ei(a, t), Ai(a, s), isNaN(n) && (n = Ye.getBestMask(
    a,
    Le.bind(null, a, r)
...
wo.create = function(t, r) {
  if (typeof t > "u" || t === "")
    throw new Error("No input text");
  let n = De.M, o, i;
  return typeof r < "u" && (n = De.from(r.errorCorrectionLevel, De.M), o = de.from(r.version), i = Ye.from(r.maskPattern), r.toSJISFunc && ye.setToSJISFunction(r.toSJISFunc)), Ii(t, o, n, i);
};
var To = {}, yr = {};
(function(e) {
  function t(r) {
  ...
  e.getOptions = function(n) {
    ...
    for (let h = 0; h < c; h++)
      for (let u = 0; u < c; u++) {
        let g = (h * c + u) * 4, f = i.color.light;
        if (h >= d && u >= d && h < c - d && u < c - d) {
          const _ = Math.floor((h - d) / a), p = Math.floor((u - d) / a);
          f = b[l[_ * s + p] ? 1 : 0];
        }
...
Mo.render = function(t, r, n) {
  const o = Ti.getOptions(r), i = t.modules.size, s = t.modules.data, l = i + o.margin * 2, a = o.color.light.a ? "<path " + Zr(o.color.light, "fill") + ' d="M0 0h' + l + "v" + l + 'H0z"/>' : "", c = "<path " + Zr(o.color.dark, "stroke") + ' d="' + Mi(s, i, o.margin) + '"/>', d = 'viewBox="0 0 ' + l + " " + l + '"', h = '<svg xmlns="http://www.w3.org/2000/svg" ' + (o.width ? 'width="' + o.width + '" height="' + o.width + '" ' : "") + d + ' shape-rendering="crispEdges">' + a + c + `</svg>
`;
  return typeof n == "function" && n(null, h), h;
};
const Si = Vn, Ge = wo, So = To, Ri = Mo;
...
Kt.create = Ge.create;
Kt.toCanvas = xr.bind(null, So.render);
Kt.toDataURL = xr.bind(null, So.renderToDataURL);
Kt.toString = xr.bind(null, function(e, t, r) {
  return Ri.render(e, r);
});
var Di = Object.defineProperty, qr = Object.getOwnPropertySymbols, Ni = Object.prototype.hasOwnProperty, Li = Object.prototype.propertyIsEnumerable, Kr = (e, t, r) => t in e ? Di(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, We = (e, t) => {
  for (var r in t || (t = {}))
...
const ki = S`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
var Hi = Object.defineProperty, zi = Object.getOwnPropertyDescriptor, $r = (e, t, r, n) => {
...
const Fi = S`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var Vi = Object.defineProperty, Zi = Object.getOwnPropertyDescriptor, qi = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Zi(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
}, Ki = S`.wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}`;
var Yi = Object.defineProperty, Qi = Object.getOwnPropertyDescriptor, Gi = (e, t, r, n) => {
...
let Xe = class extends E {
  // -- render ------------------------------------------------------- //
  render() {
    return m`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${R.WALLET_CONNECT_LOGO} <button @click="${re.close}">${R.CROSS_ICON}</button></div>`;
  }
};
Xe.styles = [A.globalCss, Ki];
Xe = Gi([
  O("wcm-modal-backcard")
], Xe);
const Ji = S`main{padding:20px;padding-top:0;width:100%}`;
...
tr.styles = [A.globalCss, Ji];
tr = es([
  O("wcm-modal-content")
], tr);
const rs = S`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
...
er.styles = [A.globalCss, rs];
er = is([
  O("wcm-modal-footer")
], er);
const ss = S`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
var ls = Object.defineProperty, as = Object.getOwnPropertyDescriptor, Qt = (e, t, r, n) => {
...
let ft = class extends E {
  ...
  // -- private ------------------------------------------------------ //
  backBtnTemplate() {
    return m`<button class="wcm-back-btn" @click="${L.goBack}">${R.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
...
const $ = {
  ...
  handleMobileLinking(e, t = "_self") {
    const { walletConnectUri: r } = q.state, { mobile: n, name: o } = e, i = n == null ? void 0 : n.native, s = n == null ? void 0 : n.universal;
    $.setRecentWallet(e);
    function l(a) {
      if (i) {
...
}, cs = S`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
var ds = Object.defineProperty, hs = Object.getOwnPropertyDescriptor, _r = (e, t, r, n) => {
...
const us = S`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
var ms = Object.defineProperty, fs = Object.getOwnPropertyDescriptor, Ro = (e, t, r, n) => {
...
let he = class extends E {
  ...
  render() {
    ...
    return this.open ? m`<div class="${G(r)}">${t === "success" ? R.CHECKMARK_ICON : null} ${t === "error" ? R.CROSS_ICON : null}<wcm-text variant="small-regular">${e}</wcm-text></div>` : null;
  }
};
he.styles = [A.globalCss, us];
Ro([
  j()
], he.prototype, "open", 2);
he = Ro([
...
const ws = {
  generate(e, t, r) {
    const n = "#141414", o = "#ffffff", i = [], s = gs(e, "Q"), l = t / s.length, a = [
      { x: 0, y: 0 },
      { x: 1, y: 0 },
      { x: 0, y: 1 }
    ];
    a.forEach(({ x: g, y: f }) => {
      const _ = (s.length - Q) * l * g, p = (s.length - Q) * l * f, y = 0.45;
      for (let v = 0; v < a.length; v += 1) {
        const w = l * (Q - v * 2);
        i.push(
          N`<rect fill="${v % 2 === 0 ? n : o}" height="${w}" rx="${w * y}" ry="${w * y}" width="${w}" x="${_ + l * v}" y="${p + l * v}">`
        );
      }
    });
    ...
    s.forEach((g, f) => {
      g.forEach((_, p) => {
        if (s[f][p] && !(f < Q && p < Q || f > s.length - (Q + 1) && p < Q || f < Q && p > s.length - (Q + 1)) && !(f > d && f < b && p > d && p < b)) {
          const y = f * l + l / 2, v = p * l + l / 2;
          h.push([y, v]);
        }
      });
    });
    ...
    return h.forEach(([g, f]) => {
      u[g] ? u[g].push(f) : u[g] = [f];
    }), Object.entries(u).map(([g, f]) => {
      const _ = f.filter(
        (p) => f.every((y) => !Ue(p, y, l))
      );
      return [Number(g), _];
    }).forEach(([g, f]) => {
      f.forEach((_) => {
        i.push(
          N`<circle cx="${g}" cy="${_}" fill="${n}" r="${l / Qr}">`
        );
      });
    }), Object.entries(u).filter(([g, f]) => f.length > 1).map(([g, f]) => {
      const _ = f.filter((p) => f.some((y) => Ue(p, y, l)));
      return [Number(g), _];
    }).map(([g, f]) => {
      f.sort((p, y) => p < y ? -1 : 1);
      const _ = [];
      ...
      return [g, _.map((p) => [p[0], p[p.length - 1]])];
    }).forEach(([g, f]) => {
      f.forEach(([_, p]) => {
        i.push(
          N`<line x1="${g}" x2="${g}" y1="${_}" y2="${p}" stroke="${n}" stroke-width="${l / (Qr / 2)}" stroke-linecap="round">`
        );
      });
    }), i;
  }
}, vs = S`@keyframes fadeIn{0%{opacity:0}100%{opacity:1}}div{position:relative;user-select:none;display:block;overflow:hidden;aspect-ratio:1/1;animation:fadeIn ease .2s}.wcm-dark{background-color:#fff;border-radius:var(--wcm-container-border-radius);padding:18px;box-shadow:0 2px 5px #000}svg:first-child,wcm-wallet-image{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{width:25%;height:25%;border-radius:var(--wcm-wallet-icon-border-radius)}svg:first-child{transform:translateY(-50%) translateX(-50%) scale(.9)}svg:first-child path:first-child{fill:var(--wcm-accent-color)}svg:first-child path:last-child{stroke:var(--wcm-color-overlay)}`;
var bs = Object.defineProperty, ys = Object.getOwnPropertyDescriptor, St = (e, t, r, n) => {
...
let nt = class extends E {
  ...
  svgTemplate() {
    ...
    return N`<svg height="${t}" width="${t}">${ws.generate(this.uri, t, t / 4)}</svg>`;
  }
  // -- render ------------------------------------------------------- //
  render() {
    const e = {
    ...
    return m`<div style="${`width: ${this.size}px`}" class="${G(e)}">${this.walletId || this.imageUrl ? m`<wcm-wallet-image walletId="${W(this.walletId)}" imageId="${W(this.imageId)}" imageUrl="${W(this.imageUrl)}"></wcm-wallet-image>` : R.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`;
  }
};
nt.styles = [A.globalCss, vs];
St([
  C()
], nt.prototype, "uri", 2);
St([
...
const xs = S`:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}`;
var $s = Object.defineProperty, _s = Object.getOwnPropertyDescriptor, Do = (e, t, r, n) => {
...
let ue = class extends E {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    return m`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${R.SEARCH_ICON}`;
  }
};
ue.styles = [A.globalCss, xs];
Do([
  C()
...
const Cs = S`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var Es = Object.defineProperty, As = Object.getOwnPropertyDescriptor, Os = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? As(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
var Ss = Object.defineProperty, Rs = Object.getOwnPropertyDescriptor, lt = (e, t, r, n) => {
...
let K = class extends E {
  ...
  render() {
    var e;
    return m`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${W(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${(e = this.label) != null ? e : $.getWalletName(this.name, !0)}</wcm-text>${this.sublabelTemplate()}</div></button>`;
  }
};
K.styles = [A.globalCss, Ms];
lt([
  C()
...
const Ds = S`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var Ns = Object.defineProperty, Ls = Object.getOwnPropertyDescriptor, xe = (e, t, r, n) => {
...
let It = class extends E {
  ...
  render() {
    ...
    return m`${t.length ? m`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>` : R.WALLET_PLACEHOLDER}`;
  }
};
It.styles = [A.globalCss, Ds];
xe([
  C()
...
var Bs = Object.defineProperty, Ws = Object.getOwnPropertyDescriptor, No = (e, t, r, n) => {
...
let or = class extends E {
  ...
  async preloadListings() {
    if (ht.state.enableExplorer) {
      ...
      const { recomendedWallets: e } = U.state, t = e.map((r) => $.getWalletIcon(r));
...
or = No([
  O("wcm-explorer-context")
], or);
var Us = Object.defineProperty, js = Object.getOwnPropertyDescriptor, ks = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? js(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
  return n && o && Us(t, r, o), o;
};
let Gr = class extends E {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
...
let nr = class extends E {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { recomendedWallets: e } = U.state, t = [...e, ...e], r = x.RECOMMENDED_WALLET_AMOUNT * 2;
    return m`<wcm-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${R.QRCODE_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-title">${R.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">WalletConnect</wcm-text></div><div class="wcm-slider"><div class="wcm-track">${[...Array(r)].map((n, o) => {
      const i = t[o % t.length];
      return i ? m`<wcm-wallet-image walletId="${i.id}" imageId="${i.image_id}"></wcm-wallet-image>` : R.WALLET_PLACEHOLDER;
...
nr.styles = [A.globalCss, Hs];
nr = Vs([
  O("wcm-android-wallet-selection")
], nr);
const Zs = S`@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}`;
var qs = Object.defineProperty, Ks = Object.getOwnPropertyDescriptor, Rt = (e, t, r, n) => {
...
let it = class extends E {
  ...
  render() {
    ...
    return m`<div class="${G(e)}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${W(this.walletId)}" imageId="${W(this.imageId)}"></wcm-wallet-image></div><wcm-text variant="medium-regular" color="${this.isError ? "error" : "primary"}">${this.isError ? "Connection declined" : this.label}</wcm-text>`;
  }
};
it.styles = [A.globalCss, Zs];
Rt([
  C()
], it.prototype, "walletId", 2);
Rt([
...
const yt = {
  ...
  recomendedWallets(e = !1) {
    var t;
    const r = e || (t = yt.recentWallet()) == null ? void 0 : t.id, { recomendedWallets: n } = U.state;
  ...
  recentWalletTemplate() {
    ...
    if (e)
      return m`<wcm-wallet-button name="${e.name}" walletId="${e.id}" imageId="${W(e.image_id)}" .recent="${!0}" .onClick="${() => this.onConnecting(e)}"></wcm-wallet-button>`;
  }
}, Ys = S`.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-desktop-title,.wcm-mobile-title{display:flex;align-items:center}.wcm-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.wcm-desktop-title{margin-bottom:10px;padding:0 10px}.wcm-subtitle{display:flex;align-items:center}.wcm-subtitle:last-child path{fill:var(--wcm-color-fg-3)}.wcm-desktop-title svg,.wcm-mobile-title svg{margin-right:6px}.wcm-desktop-title path,.wcm-mobile-title path{fill:var(--wcm-accent-color)}`;
var Qs = Object.defineProperty, Gs = Object.getOwnPropertyDescriptor, Js = (e, t, r, n) => {
...
let ir = class extends E {
  ...
  render() {
    ...
    l ? a = s.slice(0, 3) : a = s;
    const c = !!a.length;
    return m`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${$.handleUriCopy}" .actionIcon="${R.COPY_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">${R.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">${R.SCAN_ICON}<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>${c ? m`<wcm-modal-footer><div class="wcm-desktop-title">${R.DESKTOP_ICON}<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${a} ${l ? m`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-footer>` : null}`;
  }
};
ir.styles = [A.globalCss, Ys];
ir = Js([
  O("wcm-desktop-wallet-selection")
], ir);
const Xs = S`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var tl = Object.defineProperty, el = Object.getOwnPropertyDescriptor, rl = (e, t, r, n) => {
...
sr.styles = [A.globalCss, Xs];
sr = rl([
  O("wcm-legal-notice")
], sr);
const ol = S`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var nl = Object.defineProperty, il = Object.getOwnPropertyDescriptor, sl = (e, t, r, n) => {
...
let lr = class extends E {
  ...
  render() {
    ...
    l ? a = s.slice(0, 7) : a = s;
    const c = !!a.length;
    return m`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${R.QRCODE_ICON}"></wcm-modal-header>${c ? m`<wcm-modal-content><div>${a} ${l ? m`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
  }
};
lr.styles = [A.globalCss, ol];
lr = sl([
  O("wcm-mobile-wallet-selection")
], lr);
const ll = S`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
var al = Object.defineProperty, cl = Object.getOwnPropertyDescriptor, Er = (e, t, r, n) => {
...
const dl = S`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var hl = Object.defineProperty, ul = Object.getOwnPropertyDescriptor, Gt = (e, t, r, n) => {
...
let pt = class extends E {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    return m`<div>${this.isRetry ? m`<slot></slot>` : null} ${this.isMobile ? m`<wcm-button .onClick="${this.onMobile}" .iconLeft="${R.MOBILE_ICON}" variant="outline">Mobile</wcm-button>` : null} ${this.isDesktop ? m`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${R.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>` : null} ${this.isWeb ? m`<wcm-button .onClick="${this.onWeb}" .iconLeft="${R.GLOBE_ICON}" variant="outline">Web</wcm-button>` : null}</div>`;
  }
};
pt.styles = [A.globalCss, dl];
Gt([
  C({ type: Boolean })
...
var fl = Object.defineProperty, pl = Object.getOwnPropertyDescriptor, gl = (e, t, r, n) => {
...
let ar = class extends E {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { recomendedWallets: e } = U.state, t = yt.manualWallets(), r = [...e, ...t].reverse().slice(0, 4);
    return m`<button @click="${this.onClick}"><div class="wcm-icons">${r.map((n) => {
      ...
      return i ? m`<img crossorigin="anonymous" src="${i}">` : R.WALLET_PLACEHOLDER;
    })} ${[...Array(4 - r.length)].map(() => R.WALLET_PLACEHOLDER)}</div><wcm-text variant="xsmall-regular">View All</wcm-text></button>`;
  }
};
ar.styles = [A.globalCss, ml];
ar = gl([
  O("wcm-view-all-wallets-button")
], ar);
const wl = S`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var vl = Object.defineProperty, bl = Object.getOwnPropertyDescriptor, $e = (e, t, r, n) => {
...
let Tt = class extends E {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    return m`<div class="wcm-qr-container">${this.uri ? m`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${this.uri}" walletId="${W(this.walletId)}" imageId="${W(this.imageId)}"></wcm-qrcode>` : m`<wcm-spinner></wcm-spinner>`}</div>`;
  }
};
Tt.styles = [A.globalCss, wl];
$e([
  C()
...
Tt = $e([
  O("wcm-walletconnect-qr")
], Tt);
var yl = Object.defineProperty, xl = Object.getOwnPropertyDescriptor, $l = (e, t, r, n) => {
...
cr.styles = [A.globalCss];
cr = $l([
  O("wcm-connect-wallet-view")
], cr);
const _l = S`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Cl = Object.defineProperty, El = Object.getOwnPropertyDescriptor, Lo = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? El(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let me = class extends E {
  ...
  openDesktopApp() {
    const { walletConnectUri: e } = q.state, t = x.getWalletRouterData();
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}" .onAction="${$.handleUriCopy}" .actionIcon="${R.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${W(r)}" label="${`Continue in ${e}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${e} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${n}" .isWeb="${o}" .isRetry="${!0}"><wcm-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${R.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
me.styles = [A.globalCss, _l];
Lo([
  j()
], me.prototype, "isError", 2);
me = Lo([
  O("wcm-desktop-connecting-view")
], me);
const Al = S`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var Ol = Object.defineProperty, Pl = Object.getOwnPropertyDescriptor, Il = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Pl(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let dr = class extends E {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${W(r)}" label="Not Detected" .isStale="${!0}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Download ${e} to continue. If multiple browser extensions are installed, disable non ${e} ones and try again`}</wcm-text><wcm-button .onClick="${() => this.onInstall(n)}" .iconLeft="${R.ARROW_DOWN_ICON}">Download</wcm-button></wcm-info-footer>`;
  }
};
dr.styles = [A.globalCss, Al];
dr = Il([
  O("wcm-install-wallet-view")
], dr);
const Tl = S`wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}`;
var Ml = Object.defineProperty, Sl = Object.getOwnPropertyDescriptor, Bo = (e, t, r, n) => {
...
let fe = class extends E {
  ...
  openMobileApp(e = !1) {
    const { walletConnectUri: t } = q.state, r = x.getWalletRouterData();
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${W(r)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${i}" .isRetry="${!0}"><wcm-button .onClick="${() => this.openMobileApp(!1)}" .iconRight="${R.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${l ? m`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(!0)}">Try this alternate link</span></wcm-text>` : null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${W(r)}"></wcm-wallet-image><wcm-text>${`Get ${e}`}</wcm-text></div><wcm-button .iconRight="${R.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(s)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
  }
};
fe.styles = [A.globalCss, Tl];
Bo([
  j()
], fe.prototype, "isError", 2);
fe = Bo([
  O("wcm-mobile-connecting-view")
], fe);
const Rl = S`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Dl = Object.defineProperty, Nl = Object.getOwnPropertyDescriptor, Ll = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Nl(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let hr = class extends E {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}" .onAction="${$.handleUriCopy}" .actionIcon="${R.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${t}" imageId="${W(r)}"></wcm-walletconnect-qr></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${e} app`}</wcm-text><wcm-platform-selection .isDesktop="${n}" .isWeb="${o}"></wcm-platform-selection></wcm-info-footer>`;
  }
};
hr.styles = [A.globalCss, Rl];
hr = Ll([
  O("wcm-mobile-qr-connecting-view")
], hr);
var Bl = Object.defineProperty, Wl = Object.getOwnPropertyDescriptor, Ul = (e, t, r, n) => {
...
let ur = class extends E {
  // -- render ------------------------------------------------------- //
  render() {
    return m`<wcm-modal-header title="Scan the code" .onAction="${$.handleUriCopy}" .actionIcon="${R.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
  }
};
ur.styles = [A.globalCss];
ur = Ul([
  O("wcm-qrcode-view")
], ur);
const jl = S`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
var kl = Object.defineProperty, Hl = Object.getOwnPropertyDescriptor, Jt = (e, t, r, n) => {
...
let gt = class extends E {
  constructor() {
    super(...arguments), this.loading = !U.state.wallets.listings.length, this.firstFetch = !U.state.wallets.listings.length, this.search = "", this.endReached = !1, this.intersectionObserver = void 0, this.searchDebounce = $.debounce((e) => {
  ...
  async fetchWallets() {
    ...
    if (!this.endReached && (this.firstFetch || o > je && n.length < o))
      try {
        this.loading = !0;
        const s = (e = q.state.chains) == null ? void 0 : e.join(","), { listings: l } = await U.getWallets({
...
gt = Jt([
  O("wcm-wallet-explorer-view")
], gt);
const zl = S`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Fl = Object.defineProperty, Vl = Object.getOwnPropertyDescriptor, Wo = (e, t, r, n) => {
...
let pe = class extends E {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}" .onAction="${$.handleUriCopy}" .actionIcon="${R.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${W(r)}" label="${`Continue in ${e}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`${e} web app has opened in a new tab. Go there, accept the connection, and come back`}</wcm-text><wcm-platform-selection .isMobile="${n}" .isDesktop="${i ? !1 : o}" .isRetry="${!0}"><wcm-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${R.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
pe.styles = [A.globalCss, zl];
Wo([
  j()
], pe.prototype, "isError", 2);
pe = Wo([
  O("wcm-web-connecting-view")
], pe);
export {
  Zt as WcmModal,
  nt as WcmQrCode
